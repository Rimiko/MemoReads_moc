   ...
   <!--          </div>
    ...
    <div class="row ptlv">
	    ...
	    <div class="col-sm-7 well margin-well">
	        ...
	        <br>
	        <i class="fa fa-bookmark-o" aria-hidden="true"></i> Best Book :<a href="#" class="detail"><strong class="bestbook-title">すえずえ</strong></a>
	        <br>
...
<!-- 				<div class="skill">
	...
	<!-- <div class="our-team"> -->
				...
				<div class="bookshelf">
			      ...
			      <a href="#" class="detail"><img src="images/book1.jpg" class="best" ></a>
